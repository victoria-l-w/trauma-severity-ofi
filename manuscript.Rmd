...
Participants
------------
A total of `r eligibility[6,3]` patients were excluded during processing of data. `r eligibility[2,3]` patients were excluded due to not having a recorded outcome from an M&M conference. `r eligibility[3,3]` patients were excluded for being under 15 years of age. `r eligibility[4,3]` patients were excluded due to being dead on arrival at hospital. `r eligibility[5,3]` patients were excluded due to incomplete data. Figure 2 shows the selection process for eligible participants. 
...
Descriptive data
----------------
A total of `r eligibility[5,2]` participants were identified as eligible for inclusion. Their demographical and clinical characteristics are described in Table 1. `r numbers['ofi.true']` cases had at least one OFI and `r numbers['ofi.false']` cases had no OFI. The mean age for all patients was `r numbers['mean.age']` and `r numbers['pc.male']`% were male. 
