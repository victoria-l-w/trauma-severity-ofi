...
### Outcome
The studied outcome is the binary variable "opportunities for improvement" (OFI), as identified by the multidisciplinary M&M conference at Karolinska University Hospital. OFI is coded as either "Yes - at least one opportunity for improvement identified" or "No - no opportunities for improvement identified". 

### Exposures
The primary exposures of interest are the trauma severity models TRISS, TARN PS12, and NORMIT. All three of these models estimate the probability of death. This is expressed a percentage and is a continuous variable. The scores given by each of these models were calculated using recorded physiological and anatomical variables. Conversion and handling of these variables was carried out according to the SweTrau manual.
...
The PS model incorporates patient age, gender, GCS and ISS. 
...
RTS, NORMIT and PS12 were calculated according to the published algorithms from their developers [@rtsalgorithm, @normit, @psalgorithm]. TRISS was calculated using to the revised 2009 coefficients [@triss2010].
